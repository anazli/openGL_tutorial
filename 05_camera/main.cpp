...
int main()
{
    ...
    {
        process_input(w->getWindowPtr(), cam);
        ...
        GLuint viewLoc = glGetUniformLocation(sh->getId(), "view");
        glUniformMatrix4fv(viewLoc, 1, GL_FALSE, glm::value_ptr(view));
        GLuint projectionLoc = glGetUniformLocation(sh->getId(), "projection");
        ...
        for(int i = 0 ; i < 5 ; ++i)
        {
            ...
            GLuint modelLoc = glGetUniformLocation(sh->getId(), "model");
